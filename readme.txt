=== Snippets Done Right ===
Tags: syntax highlighter, code highlighter, snippets, code snippets, embed, pastes, code library
...
Create and embed code snippets with syntax highlighting.

== Description ==

Snippets Done Right allows you to create code snippets in over 100 programming languages and choose between 32 highlighter themes.

The front-end and back-end are powered by ACE Editor. It provides syntax highlight in PHP, HTML, CSS, Javascript, Java, Python and many more.
